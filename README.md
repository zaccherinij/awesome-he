...
- [fhEVM](https://github.com/zama-ai/tfhe-rs) - fhEVM is a technology that enables confidential smart contracts on the EVM using FHE by [Zama](https://github.com/zama-ai).
